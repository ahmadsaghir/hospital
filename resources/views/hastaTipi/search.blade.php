...
@section('content')
            ...
            <div class="container" data-scrollax-parent="true">
                <div class="row slider-text align-items-end">
                    <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                        <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="/otomasyon/hastaTipleri">Hasta Tipleri</a></span> <span>Arama</span></p>
    ...
    <section class="ftco-section">
        <div class="container">
            ...
            <div class="row">
                @if($hastaTipleri->isNotEmpty())
                @foreach($hastaTipleri as $hastaTipi)
                    <div class="col-md-3 ftco-animate">
                        <div class="pricing-entry pb-5 text-center">
                            <div>
                                <p><span class="price">{{$hastaTipi->count()}}</span></p>
                                <h3 class="mb-4">{{$hastaTipi->hastaTipiAd}}</h3>
                            </div>
                ...
                @else
                    <div class="col-md-12 text-center heading-section ftco-animate">
                        <h2 class="mb-3">Hasta Tipi Bulunmadı</h2>
                    </div>
                @endif
            </div>
        </div>
