            ...
            <div class="container" data-scrollax-parent="true">
                <div class="row slider-text align-items-end">
                    <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                        <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="/otomasyon/hastalar">Hastalar</a></span> <span>{{$hasta->hastaAd}}</span></p>
                        <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">{{$hasta->hastaAd}}</h1>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="blog-entry">
                                <div class="text d-flex py-4">
                                    ...
                                    <div class="desc pl-sm-3 pl-md-5">
                                        ...
                                        <p>Doğum Yeri : {{$hasta->dogumYeri}}</p>
                                        <p>Cinsiyet : {{$hasta->cinsiyet}}</p>
                                        <p>Medeni Hal : {{$hasta->medeniHal}}</p>
                                        <p>Adres : {{$hasta->adres}}</p>
                                        <div class="row">
                                            <div class="col-2">
                                                <p><a href=/otomasyon/hastalar/{{$hasta->id}}/edit class="btn btn-primary btn-outline-primary">Düzenle</a></p>
                                            </div>
                                            <div class="col-2">
                                                <p><a href="{{route('hasta.delete',$hasta->id)}}" class="btn btn-primary btn-outline-primary">Sil</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
